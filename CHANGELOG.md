<a name="1.0.11"></a>
## [1.0.11](https://github.com/unity-template/utils/compare/v1.0.10...v1.0.11) (2022-06-30)


### Features

* 注释超时测试用例 ([2f863a4](https://github.com/unity-template/utils/commit/2f863a4))
...
* 修改release tag 配置 ([7ca2b6e](https://github.com/unity-template/utils/commit/7ca2b6e))
...
* 🎸 添加getDeviceWidth工具函数 ([5590e20](https://github.com/unity-template/utils/commit/5590e20))
